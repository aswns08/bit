...
public class LoginControl {
	 ...
	 * =>쿠키가 없으면 다음 오류가 뜬다.
	 * 
	 * The request sent by the client was syntatically incorrect
	 * 
	 * required => 필수 여부 지정 (기본은 true)
	 * defaultValue => 기본 값 지정( 값이 없을 때 지정된 값.)
	 */
	

	@RequestMapping(method=RequestMethod.GET)
	public String form(@CookieValue(/*required=false*/defaultValue="") String uid, 
