...
public class test44_2 /*extends Object*/ {
  ...
  public static void main(String[] args) {
    ...
    // Vehcle의 서브 클래스의 객체를 가리킬 때도 사용될 수 있다.
    ...
    // 수퍼 클래스는 서브 클래스보다 기능이 적을 수 있기 때문에.
//  Vehicle obj6 = new Soldier(); // 오류!!!
    
    
//    퀴즈1
    // Tank와 Vulture, Soldier 객체를 저장할 수 있는 참조변수 배열을 선언하시오.
    
    Mover[] m = new Mover[10];
    Unit[] u = new Unit[10];
    
//    퀴즈2
    // 수퍼 클래스의 참조 변수로 서브 클래스를 가리킬 때
    // 비록 수퍼 클래스의 메서드를 호출 하더라도,
